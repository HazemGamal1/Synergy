...
import { PlusCircle, Loader2, User, Github, Plus, LinkIcon } from 'lucide-react'
      ...
      <Card className='border-none w-full '>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <Label htmlFor="discordLink" className='flex gap-2 items-center mb-4'><LinkIcon size={'20px'}/> Links</Label>
